...
START_HOTSPOTS(ToolLibrary)
	...
	DEFINE_HOTSPOT(ToolDesc, ToolLib, 274, 10, 653, 70)
	DEFINE_HOTSPOT(ToolsDone, ToolLib, 664, 10, 723, 69)
	DEFINE_HOTSPOT(ToolDelete, ToolLib, 734, 10, 793, 69)
	DEFINE_HOTSPOT(ToolImportExport, ToolLib, 804, 10, 863, 69)
...
START_AREAS(ToolLibrary)
	...
	DEFINE_AREA(ToolDesc, 279, 28, 374, 28)
END_AREAS(ToolLibrary)

START_SCREEN(ToolRow)
	IMAGE_ADDRESS(1606920)
	IMAGE_SIZE(52224)
	IMAGE_WIDTH(512)
	IMAGE_HEIGHT(51)
	IMAGE_STRIDE(512)
...
START_GROUP(ToolLib)
	...
	GROUP_HOTSPOT(ToolDesc, ToolLib, 274, 10, 653, 70)
...
START_GROUP_ToolLib(ToolLib)
	...
	GROUP_HOTSPOT_ToolLib(ToolDesc, ToolLib, 274, 10, 653, 70)
...
START_SCREEN_Overlay(ToolButtons)
	IMAGE_ADDRESS_Overlay(1659144)
	IMAGE_SIZE_Overlay(85600)
	IMAGE_WIDTH_Overlay(400)
