...
START_HOTSPOTS(ToolImport)
	DEFINE_HOTSPOT(FileName, ToolLib, 10, 10, 748, 69)
...
START_AREAS(ToolImport)
	DEFINE_AREA(FileName, 20, 26, 719, 28)
...
START_AREAS(FileRow)
	DEFINE_AREA(AllText, 52, 12, 750, 28)
	DEFINE_AREA(FileSize, 712, 12, 90, 28)
	DEFINE_AREA(FileTime, 587, 12, 105, 28)
	DEFINE_AREA(FileDate, 442, 12, 125, 28)
	DEFINE_AREA(FileName, 52, 12, 370, 28)
...
START_SCREEN_Overlay(LoadSave)
	IMAGE_ADDRESS_Overlay(3212384)
	IMAGE_SIZE_Overlay(38520)
	IMAGE_WIDTH_Overlay(180)
	IMAGE_HEIGHT_Overlay(107)
...
START_SCREEN_Overlay(ImportWarning)
	IMAGE_ADDRESS_Overlay(3255000)
	IMAGE_SIZE_Overlay(47952)
	IMAGE_WIDTH_Overlay(645)
	IMAGE_HEIGHT_Overlay(37)
	IMAGE_STRIDE_Overlay(648)
	IMAGE_DEPTH_Overlay(Color16bpp)
END_SCREEN_Overlay(ImportWarning)

START_SCREEN_Overlay(TimestampLabel)
	IMAGE_ADDRESS_Overlay(3302952)
