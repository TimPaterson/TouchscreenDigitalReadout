...
START_HOTSPOTS(SettingsScreen)
	DEFINE_HOTSPOT(Xsensor, Disable, 63, 81, 182, 140)
	DEFINE_HOTSPOT(Xsensor, Resolution, 182, 81, 301, 140)
	DEFINE_HOTSPOT(Xsensor, Invert, 301, 81, 420, 140)
	DEFINE_HOTSPOT(Xsensor, Correction, 420, 81, 539, 140)
	DEFINE_HOTSPOT(Ysensor, Disable, 63, 140, 182, 199)
	DEFINE_HOTSPOT(Ysensor, Resolution, 182, 140, 301, 199)
	DEFINE_HOTSPOT(Ysensor, Invert, 301, 140, 420, 199)
	DEFINE_HOTSPOT(Ysensor, Correction, 420, 140, 539, 199)
	DEFINE_HOTSPOT(Zsensor, Disable, 63, 199, 182, 258)
	DEFINE_HOTSPOT(Zsensor, Resolution, 182, 199, 301, 258)
	DEFINE_HOTSPOT(Zsensor, Invert, 301, 199, 420, 258)
	DEFINE_HOTSPOT(Zsensor, Correction, 420, 199, 539, 258)
...
START_GROUP(Disable)
	GROUP_HOTSPOT(Xsensor, Disable, 63, 81, 182, 140)
	GROUP_HOTSPOT(Ysensor, Disable, 63, 140, 182, 199)
	GROUP_HOTSPOT(Zsensor, Disable, 63, 199, 182, 258)
	GROUP_HOTSPOT(Qsensor, Disable, 63, 258, 182, 317)
END_GROUP(Disable)

START_GROUP(Resolution)
	GROUP_HOTSPOT(Xsensor, Resolution, 182, 81, 301, 140)
	GROUP_HOTSPOT(Ysensor, Resolution, 182, 140, 301, 199)
	GROUP_HOTSPOT(Zsensor, Resolution, 182, 199, 301, 258)
	GROUP_HOTSPOT(Qsensor, Resolution, 182, 258, 301, 317)
END_GROUP(Resolution)

START_GROUP(Invert)
	GROUP_HOTSPOT(Xsensor, Invert, 301, 81, 420, 140)
	GROUP_HOTSPOT(Ysensor, Invert, 301, 140, 420, 199)
	GROUP_HOTSPOT(Zsensor, Invert, 301, 199, 420, 258)
	GROUP_HOTSPOT(Qsensor, Invert, 301, 258, 420, 317)
END_GROUP(Invert)

START_GROUP(Correction)
	GROUP_HOTSPOT(Xsensor, Correction, 420, 81, 539, 140)
	GROUP_HOTSPOT(Ysensor, Correction, 420, 140, 539, 199)
	GROUP_HOTSPOT(Zsensor, Correction, 420, 199, 539, 258)
...
START_GROUP_Disable(Disable)
	GROUP_HOTSPOT_Disable(Xsensor, Disable, 63, 81, 182, 140)
	GROUP_HOTSPOT_Disable(Ysensor, Disable, 63, 140, 182, 199)
	GROUP_HOTSPOT_Disable(Zsensor, Disable, 63, 199, 182, 258)
...
START_GROUP_Resolution(Resolution)
	GROUP_HOTSPOT_Resolution(Xsensor, Resolution, 182, 81, 301, 140)
	GROUP_HOTSPOT_Resolution(Ysensor, Resolution, 182, 140, 301, 199)
	GROUP_HOTSPOT_Resolution(Zsensor, Resolution, 182, 199, 301, 258)
...
START_GROUP_Invert(Invert)
	GROUP_HOTSPOT_Invert(Xsensor, Invert, 301, 81, 420, 140)
	GROUP_HOTSPOT_Invert(Ysensor, Invert, 301, 140, 420, 199)
	GROUP_HOTSPOT_Invert(Zsensor, Invert, 301, 199, 420, 258)
...
START_GROUP_Correction(Correction)
	GROUP_HOTSPOT_Correction(Xsensor, Correction, 420, 81, 539, 140)
	GROUP_HOTSPOT_Correction(Ysensor, Correction, 420, 140, 539, 199)
	GROUP_HOTSPOT_Correction(Zsensor, Correction, 420, 199, 539, 258)
