...
START_HOTSPOTS(MainScreen)
	DEFINE_HOTSPOT(Xdisplay, Axis, 0, 15, 409, 126)
	DEFINE_HOTSPOT(Xbutton, , 435, 23, 519, 118)
	DEFINE_HOTSPOT(Ydisplay, Axis, 0, 157, 409, 268)
	DEFINE_HOTSPOT(Ybutton, , 435, 165, 519, 260)
	DEFINE_HOTSPOT(Zdisplay, Axis, 0, 299, 409, 410)
	DEFINE_HOTSPOT(Zbutton, , 435, 307, 519, 402)
	...
	DEFINE_HOTSPOT(Mem1, , 850, 227, 999, 286)
	...
	DEFINE_HOTSPOT(Mem2, , 850, 297, 999, 356)
	...
	DEFINE_HOTSPOT(Mem3, , 850, 367, 999, 426)
	...
	DEFINE_HOTSPOT(Mem4, , 850, 437, 999, 496)
	...
	DEFINE_HOTSPOT(Mem5, , 850, 507, 999, 566)
...
START_LOCATIONS(MainScreen)
	...
	DEFINE_LOCATION(Yaxis, 0, 157)
	DEFINE_LOCATION(Zaxis, 0, 299)
	DEFINE_LOCATION(Undo3, 560, 15)
	DEFINE_LOCATION(Undo2, 560, 43)
	DEFINE_LOCATION(Undo1, 560, 71)
	DEFINE_LOCATION(CalcDisplay, 560, 109)
	DEFINE_LOCATION(CalcText, 560, 179)
	DEFINE_LOCATION(Mem1, 850, 227)
	DEFINE_LOCATION(Mem2, 850, 297)
	DEFINE_LOCATION(Mem3, 850, 367)
	DEFINE_LOCATION(Mem4, 850, 437)
	DEFINE_LOCATION(Mem5, 850, 507)
END_LOCATIONS(MainScreen)

START_AREAS(MainScreen)
	DEFINE_AREA(Xdisplay, 0, 15, 410, 112)
	DEFINE_AREA(Ydisplay, 0, 157, 410, 112)
	DEFINE_AREA(Zdisplay, 0, 299, 410, 112)
...
START_GROUP(Axis)
	GROUP_HOTSPOT(Xdisplay, Axis, 0, 15, 409, 126)
	GROUP_HOTSPOT(Ydisplay, Axis, 0, 157, 409, 268)
	GROUP_HOTSPOT(Zdisplay, Axis, 0, 299, 409, 410)
END_GROUP(Axis)

START_GROUP()
	GROUP_HOTSPOT(Xbutton, , 435, 23, 519, 118)
	GROUP_HOTSPOT(Ybutton, , 435, 165, 519, 260)
	GROUP_HOTSPOT(Zbutton, , 435, 307, 519, 402)
	...
	GROUP_HOTSPOT(Mem1, , 850, 227, 999, 286)
	GROUP_HOTSPOT(Mem2, , 850, 297, 999, 356)
	GROUP_HOTSPOT(Mem3, , 850, 367, 999, 426)
	GROUP_HOTSPOT(Mem4, , 850, 437, 999, 496)
	GROUP_HOTSPOT(Mem5, , 850, 507, 999, 566)
END_GROUP()
...
START_GROUP_Axis(Axis)
	GROUP_HOTSPOT_Axis(Xdisplay, Axis, 0, 15, 409, 126)
	GROUP_HOTSPOT_Axis(Ydisplay, Axis, 0, 157, 409, 268)
	GROUP_HOTSPOT_Axis(Zdisplay, Axis, 0, 299, 409, 410)
END_GROUP_Axis(Axis)
...
START_GROUP_()
	GROUP_HOTSPOT_(Xbutton, , 435, 23, 519, 118)
	GROUP_HOTSPOT_(Ybutton, , 435, 165, 519, 260)
	GROUP_HOTSPOT_(Zbutton, , 435, 307, 519, 402)
	...
	GROUP_HOTSPOT_(Mem1, , 850, 227, 999, 286)
	GROUP_HOTSPOT_(Mem2, , 850, 297, 999, 356)
	GROUP_HOTSPOT_(Mem3, , 850, 367, 999, 426)
	GROUP_HOTSPOT_(Mem4, , 850, 437, 999, 496)
	GROUP_HOTSPOT_(Mem5, , 850, 507, 999, 566)
END_GROUP_()
