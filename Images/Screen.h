...
START_HOTSPOTS(SettingsScreen)
	DEFINE_HOTSPOT(Xsensor, Resolution, 63, 81, 182, 140)
	DEFINE_HOTSPOT(Xsensor, Invert, 182, 81, 301, 140)
	DEFINE_HOTSPOT(Xsensor, Correction, 301, 81, 420, 140)
	DEFINE_HOTSPOT(Ysensor, Resolution, 63, 140, 182, 199)
	DEFINE_HOTSPOT(Ysensor, Invert, 182, 140, 301, 199)
	DEFINE_HOTSPOT(Ysensor, Correction, 301, 140, 420, 199)
	DEFINE_HOTSPOT(Zsensor, Resolution, 63, 199, 182, 258)
	DEFINE_HOTSPOT(Zsensor, Invert, 182, 199, 301, 258)
	DEFINE_HOTSPOT(Zsensor, Correction, 301, 199, 420, 258)
	DEFINE_HOTSPOT(Qsensor, Resolution, 63, 258, 182, 317)
	DEFINE_HOTSPOT(Qsensor, Invert, 182, 258, 301, 317)
	DEFINE_HOTSPOT(Qsensor, Correction, 301, 258, 420, 317)
...
HOTSPOT_COUNT(SettingsScreen, 18)

START_AREAS(SettingsScreen)
	DEFINE_AREA(Xresolution, 113, 91, 69, 42)
	DEFINE_AREA(Xinvert, 226, 95, 32, 32)
	DEFINE_AREA(Xcorrection, 306, 91, 114, 42)
	DEFINE_AREA(Yresolution, 113, 150, 69, 42)
	DEFINE_AREA(Yinvert, 226, 154, 32, 32)
	DEFINE_AREA(Ycorrection, 306, 150, 114, 42)
	DEFINE_AREA(Zresolution, 113, 209, 69, 42)
	DEFINE_AREA(Zinvert, 226, 213, 32, 32)
	DEFINE_AREA(Zcorrection, 306, 209, 114, 42)
	DEFINE_AREA(Qresolution, 113, 268, 69, 42)
	DEFINE_AREA(Qinvert, 226, 272, 32, 32)
	DEFINE_AREA(Qcorrection, 306, 268, 114, 42)
...
START_HOTSPOTS(ToolImport)
	DEFINE_HOTSPOT(FileName, ToolLib, 10, 10, 644, 69)
	DEFINE_HOTSPOT(ImportRadio, ToolLib, 645, 8, 738, 57)
	DEFINE_HOTSPOT(ExportRadio, ToolLib, 645, 58, 738, 107)
...
HOTSPOT_COUNT(ToolImport, 8)

START_AREAS(ToolImport)
	DEFINE_AREA(FileName, 20, 26, 615, 28)
...
START_GROUP(ToolLib)
	...
	GROUP_HOTSPOT(FileName, ToolLib, 10, 10, 644, 69)
	GROUP_HOTSPOT(ImportRadio, ToolLib, 645, 8, 738, 57)
	GROUP_HOTSPOT(ExportRadio, ToolLib, 645, 58, 738, 107)
...
START_GROUP(Resolution)
	GROUP_HOTSPOT(Xsensor, Resolution, 63, 81, 182, 140)
	GROUP_HOTSPOT(Ysensor, Resolution, 63, 140, 182, 199)
	GROUP_HOTSPOT(Zsensor, Resolution, 63, 199, 182, 258)
	GROUP_HOTSPOT(Qsensor, Resolution, 63, 258, 182, 317)
END_GROUP(Resolution)

START_GROUP(Invert)
	GROUP_HOTSPOT(Xsensor, Invert, 182, 81, 301, 140)
	GROUP_HOTSPOT(Ysensor, Invert, 182, 140, 301, 199)
	GROUP_HOTSPOT(Zsensor, Invert, 182, 199, 301, 258)
	GROUP_HOTSPOT(Qsensor, Invert, 182, 258, 301, 317)
END_GROUP(Invert)

START_GROUP(Correction)
	GROUP_HOTSPOT(Xsensor, Correction, 301, 81, 420, 140)
	GROUP_HOTSPOT(Ysensor, Correction, 301, 140, 420, 199)
	GROUP_HOTSPOT(Zsensor, Correction, 301, 199, 420, 258)
	GROUP_HOTSPOT(Qsensor, Correction, 301, 258, 420, 317)
...
START_GROUP_ToolLib(ToolLib)
	...
	GROUP_HOTSPOT_ToolLib(FileName, ToolLib, 10, 10, 644, 69)
	GROUP_HOTSPOT_ToolLib(ImportRadio, ToolLib, 645, 8, 738, 57)
	GROUP_HOTSPOT_ToolLib(ExportRadio, ToolLib, 645, 58, 738, 107)
...
START_GROUP_Resolution(Resolution)
	GROUP_HOTSPOT_Resolution(Xsensor, Resolution, 63, 81, 182, 140)
	GROUP_HOTSPOT_Resolution(Ysensor, Resolution, 63, 140, 182, 199)
	GROUP_HOTSPOT_Resolution(Zsensor, Resolution, 63, 199, 182, 258)
	GROUP_HOTSPOT_Resolution(Qsensor, Resolution, 63, 258, 182, 317)
...
START_GROUP_Invert(Invert)
	GROUP_HOTSPOT_Invert(Xsensor, Invert, 182, 81, 301, 140)
	GROUP_HOTSPOT_Invert(Ysensor, Invert, 182, 140, 301, 199)
	GROUP_HOTSPOT_Invert(Zsensor, Invert, 182, 199, 301, 258)
	GROUP_HOTSPOT_Invert(Qsensor, Invert, 182, 258, 301, 317)
...
START_GROUP_Correction(Correction)
	GROUP_HOTSPOT_Correction(Xsensor, Correction, 301, 81, 420, 140)
	GROUP_HOTSPOT_Correction(Ysensor, Correction, 301, 140, 420, 199)
	GROUP_HOTSPOT_Correction(Zsensor, Correction, 301, 199, 420, 258)
	GROUP_HOTSPOT_Correction(Qsensor, Correction, 301, 258, 420, 317)
